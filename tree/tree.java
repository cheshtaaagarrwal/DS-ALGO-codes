...
public class tree {
        ...
        while (que.size() != 0) {
            ...
            while (size-- > 0) {
                ...
                if (rnode.node.left != null)
                    que.addLast(new Pairvo(rnode.node.left, rnode.vl - 1));
                if (rnode.node.right != null)
                    que.addLast(new Pairvo(rnode.node.right, rnode.vl + 1));
            }
        }
        ...
        while (que.size() != 0) {
            ...
            while (size-- > 0) {
                ...
                if (rnode.node.left != null)
                    que.addLast(new Pairvo(rnode.node.left, rnode.vl - 1));
                if (rnode.node.right != null)
                    que.addLast(new Pairvo(rnode.node.right, rnode.vl + 0));
            }
        }
        for (ArrayList<Integer> ar : arr)
            System.out.println(ar);
    ...
    // }
    // @Override
    // public int compareTo(Pairvo o){// for c++: bool opeartor < ( pairvo const &
    // o) const{
    // if(this.vl==o.vl)
    ...
    // if (rpair.node.left != null) cque.add(new Pairvo(rpair.node.left, rpair.vl -
    // 1));
    // if (rpair.node.right != null) cque.add(new Pairvo(rpair.node.right, rpair.vl
    // + 1));
    // }
